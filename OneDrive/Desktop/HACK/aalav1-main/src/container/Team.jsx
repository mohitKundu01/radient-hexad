...
import yakshit from '../assets/vimeet.png';
...
const Team = () => {
  return (
    ...
    >
      ...
      <div className="mx-auto grid min-w-0 max-w-screen-xl grid-cols-1 gap-4 px-4 sm:grid-cols-2 lg:grid-cols-2">
        ...
        <article className="noise-panel flex flex-col min-w-0 relative text-gray-200">
          <div className="flex flex-1 flex-col gap-6 p-6 text-left ">
            <div className="flex h-full flex-col justify-between ">
              <aside className="code">Mohit</aside>
              <img
                src={yakshit}
                alt="yakshit"
                className="object-cover mx-auto w-auto h-[20rem]"
